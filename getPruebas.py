...
descargable = requests.get("https://api.psicoweb.com/v1/aplicaciones/link/ExcelConcentrado?prueba=Valores&puesto=NECNOCTerVal", headers = autorizacion)
infoCargos= json.loads(descargable.text).get("data")
linkdes=infoCargos.get("link")
resp = requests.get(linkdes)
open("C:\\Users\\CO-166\\Desktop\\pruebas combinaciones\\test.xlsx", "wb").write(resp.content)
